...
**Hero succession:** the Necromancer transforms rather than resurrects. **Lich — Hero. Ascension Cost: 6 Corpses** (built on the Necromancer's corpse). 4 ATK | 7 HP | 2 Armor. **Soul Drain:** whenever another Unit dies, heal 1 HP. **Mass Resurrection — 5 AP, Tap:** summon 2 Skeletons. Possible future **Phylactery** mechanic for further resurrection.
