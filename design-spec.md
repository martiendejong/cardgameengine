...
**Hero succession:** the Necromancer transforms rather than resurrects. **Lich — Hero. Ascension Cost: 6 Death Power + exile 3 Corpses** (built on the Necromancer's corpse). 4 ATK | 7 HP | 2 Armor. **Soul Drain:** whenever another Unit dies, heal 1 HP. **Mass Resurrection — 5 Death Power, Tap:** exile up to 3 Corpses → summon a Skeleton for each. Possible future **Phylactery** mechanic for further resurrection.
